...
print("")
print("Number of terminal complexes: ",len(crn.terminal_complexes))
print("Terminal complexes: {}".format(crn.terminal_complexes))
print("Number of terminal complexes: ",len(crn.non_terminal_complexes))
...
print("The reaction is ma? ",crn.is_ma)
print("The reaction is weakly reversible? ",crn.is_weakly_rev)
